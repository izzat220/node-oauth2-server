		...
		.spread(function (expiresAt, client, user) {
			...
			return Promise.bind(this)
				...
				.then(function (authorizationCode) {
					...
					return this.saveAuthorizationCode(
						authorizationCode,
						expiresAt,
						scope,
						client,
...
AuthorizeHandler.prototype.getUser = function (request, response) {
	...
	return promisify(this.authenticateHandler.handle, 2)(request, response).then(
		function (user) {
			if (!user) {
...
AuthorizeHandler.prototype.saveAuthorizationCode = function (
	...
	return promisify(this.model.saveAuthorizationCode, 3).call(
		this.model,
		code,
		client,
		user
...
AuthorizeHandler.prototype.buildSuccessRedirectUri = function (
	redirectUri,
	responseType
) {
...
AuthorizeHandler.prototype.buildErrorRedirectUri = function (
	redirectUri,
	error
) {
...
AuthorizeHandler.prototype.updateResponse = function (
	response,
	redirectUri,
	state
) {
